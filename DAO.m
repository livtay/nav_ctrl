...
- (void)createCompanies {
    ...
    Company *apple = [[Company alloc] initWithCompanyName:@"Apple mobile devices" andLogo:@"apple.png"];
    ...
    Company *samsung = [[Company alloc] initWithCompanyName:@"Samsung mobile devices" andLogo:@"Samsung.png"];
    ...
    Company *nokia = [[Company alloc] initWithCompanyName:@"Nokia mobile devices" andLogo:@"Nokia2.jpg"];
    ...
    Company *motorola = [[Company alloc] initWithCompanyName:@"Motorola mobile devices" andLogo:@"motorola2.jpg"];
